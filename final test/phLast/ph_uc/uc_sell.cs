...
namespace ph.uc
{
  public partial class uc_sell : UserControl
  {
    ...
    {
      query = "UPDATE druginfo SET quantity_of_bucket = (quantity_of_tabs / 2);";
      fn.setData(query,"Hi ,data has been updated!");
      nametxt.Text = "";
      comname.Text = "";
      med_price.Text = "";
      total_price.Text = "";
    ...
    private void parshase_btn_Click(object sender, EventArgs e)
    {
      ...
      print.SubTitle = String.Format("Date :", DateTime.Now.Date);
    ...
    private void remove_btn_Click(object sender, EventArgs e)
    {
      if(sn != null) { 
          ...
          query = "SELECT quantity_of_bucket,quantity_of_tabs FROM druginfo WHERE sn ='" + sn + "';";
          ds = fn.getdata(query);
          int buc_q = int.Parse(ds.Tables[0].Rows[0][0].ToString());
          int tab_q  = int.Parse(ds.Tables[0].Rows[0][1].ToString());
          int n_quantities = (int)(buc_q + numbuc + (numtab / 2));
          int n_quantities_of_tabs = (int)(tab_q +numtab + (numbuc * 2) );
