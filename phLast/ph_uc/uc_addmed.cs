  ...
  public partial class uc_addmed : UserControl
  {
    ...
    private void signbtn_Click(object sender, EventArgs e)
    {
      ...
      if (ds.Tables[0].Rows.Count == 0)
      {
        ...
        query = "INSERT INTO druginfo (id,medname,quantity,price,tabs,company,expire) values ('" + id + "','" + name + "','" + total_quantity + "','" + price + "','" + tbs + "','" + company + "','" + date + "')";
      ...
      else
      {
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
          ...
          query = "UPDATE druginfo SET quantity = '" + total_quantity + "' WHERE medname ='" + name + "' AND expire = '" + date + "' AND company ='" + company + "'";
